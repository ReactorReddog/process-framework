package com.cn.processframework.tools.string;
...
public class StringUtils extends StrUtil {
     ...
     * 下划线转驼峰
     * @param str 字符串
     * @return reddog_split ->reddogSplit
     */
     ...
     * 驼峰转下划线
     * @param str 字符串
     * @return reddogSplit->reddog_split
     */
...
//        System.out.println(getContentBytes("xxxaa","utf-8"));
//        System.out.println(StringUtils.matchDomain("9022415@qq.com"));
...
//        System.out.println(formatIdCard("530629199504041214"));
//        System.out.println(Arrays.stream(toStringAndSplit("狗卫苏", "卫")).collect(Collectors.toList()));
//        System.out.println(toLowerCaseFirstOne("AczxSSSxcvz"));
//        System.out.println(underScoreCase2CamelCase("reddog_split"));
//        System.out.println(camelCase2UnderScoreCase("reddogSpl"));
    }
