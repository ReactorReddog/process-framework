...
public class ServiceContext extends ConcurrentHashMap<String, Object> {
    ...
    public static final String REQUEST_KEY = "reddog-request";
    public static final String RESPONSE_KEY = "reddog-response";
    public static final String OPEN_CONTEXT_KEY = "reddog-open-context";
