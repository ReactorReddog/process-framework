 ...
 * @author apple
 */
public class ProcessServerHttpRequestDecorator extends ServerHttpRequestDecorator {
     ...
     */
    public ProcessServerHttpRequestDecorator(ServerHttpRequest delegate, String queryString) {
        super(delegate);
     ...
     */
    public ProcessServerHttpRequestDecorator(ServerHttpRequest delegate, byte[] bodyData) {
        super(delegate);
        if (bodyData == null) {
