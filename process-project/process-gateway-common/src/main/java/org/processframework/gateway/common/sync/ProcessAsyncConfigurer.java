package org.processframework.gateway.common.sync;
...
public class ProcessAsyncConfigurer implements AsyncConfigurer {
    ...
    public ProcessAsyncConfigurer(String threadName, int poolSize) {
        threadPoolExecutor = new ThreadPoolExecutor(poolSize, poolSize,
                0L, TimeUnit.MILLISECONDS,
                new LinkedBlockingQueue<>(), new ProcessThreadFactory(threadName));
    }
