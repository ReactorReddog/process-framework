...
public interface OssRequest {
     ...
     * @return InputStream
     */
    OssFileInfo statFile(String fileName);
     ...
     * @return InputStream
     */
    OssFileInfo statFile(String bucketName, String fileName);
     ...
     * @return ProcessFile
     */
    ProcessFileInfo putFile(MultipartFile file);
     ...
     * @return ProcessFile
     */
    ProcessFileInfo putFile(String fileName, MultipartFile file);
     ...
     * @return ProcessFile
     */
    ProcessFileInfo putFile(String bucketName, String fileName, MultipartFile file);
     ...
     */
    ProcessFileInfo putFile(String fileName, InputStream stream);
     ...
     * @return ProcessFileInfo
     */
    ProcessFileInfo putFile(String bucketName, String fileName, InputStream stream);
